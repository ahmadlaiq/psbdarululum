                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @foreach ($dataUser as $data)
                                    ...
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="pendidikan_nonformal" class="form-select form-select-sm"
                                                ...
                                                <option selected disabled>Pilih Pendidikan Terakhir</option>
                                                <option value="TPQ" @if (old('pendidikan_nonformal', $data->pendidikan_nonformal) == 'TPQ') {{ 'selected' }} @endif>TPQ</option>
                                                <option value="MADIN" @if (old('pendidikan_nonformal', $data->pendidikan_nonformal) == 'MADIN') {{ 'selected' }} @endif>MADIN</option>
                                                <option value="Pesantren" @if (old('pendidikan_nonformal', $data->pendidikan_nonformal) == 'Pesantren') {{ 'selected' }} @endif>Pesantren</option>
                                                <option value="Tidak Ada" @if (old('pendidikan_nonformal', $data->pendidikan_nonformal) == 'Tidak Ada') {{ 'selected' }} @endif>Tidak ada</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <input name="nama_lembaga" type="text" class="form-control form-control-sm"
                                                value="{{ old('nama_lembaga', $data->nama_lembaga) }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        <label class="col-sm-2 col-form-label col-form-label-sm text-dark">Alamat Lembaga
                                            Pendidikan</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control form-control-sm" name="alamat_lembaga"
                                                value="{{ old('alamat_lembaga', $data->alamat_lembaga) }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" min="0" class="form-control form-control-sm"
                                                name="tahun_lulus" value="{{ old('tahun_lulus', $data->tahun_lulus) }}">
                                        </div>
                                    </div>
                                    <hr class="mt-3 mb-3" />
                                    <div class="form-group row mt-4">
                                        <label class="col-sm-2 col-form-label col-form-label-sm text-dark">Tanggal, Bulan
                                            Tahun Masuk Pesantren</label>
                                        <div class="col-sm-4">
                                            <input type="date" name="tanggal_masuk_pesantren"
                                                class="form-control form-control-sm"
                                                value="{{ $data->tanggal_masuk_pesantren }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-select form-select-sm" name="pendidikan_tambahan"
                                                ...
                                                <option value="Menghafal Al-Qur'an" @if (old('pendidikan_tambahan', $data->pendidikan_tambahan) == "Menghafal Al-Qur'an") {{ 'selected' }} @endif>Menghafal
                                                    Al-Qur'an</option>
                                                <option value="Abdi Ndalem" @if (old('pendidikan_tambahan', $data->pendidikan_tambahan) == 'Abdi Ndalem') {{ 'selected' }} @endif>Abdi Ndalem</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-select form-select-sm" name="pendidikan_formal"
                                                ...
                                                <option value="Pelajar SMP" @if (old('pendidikan_formal', $data->pendidikan_formal) == 'Pelajar SMP') {{ 'selected' }} @endif>Pelajar SMP</option>

                                                <option value="Pelajar SMA/SMK" @if (old('pendidikan_formal', $data->pendidikan_formal) == 'Pelajar SMA/SMK') {{ 'selected' }} @endif>Pelajar SMK
                                                </option>

                                                <option value="Mahasiswa" @if (old('pendidikan_formal', $data->pendidikan_formal) == 'Mahasiswa') {{ 'selected' }} @endif>Mahasiswa</option>

                                                <option value="Tidak Sekolah" @if (old('pendidikan_formal', $data->pendidikan_formal) == 'Tidak Sekolah') {{ 'selected' }} @endif>Tidak Sekolah
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-select form-select-sm" name="kelas_pendidikan_formal"
                                                ...
                                                <option value="VII" @if (old('kelas_pendidikan_formal', $data->kelas_pendidikan_formal) == 'VII') {{ 'selected' }} @endif>VII</option>
                                                <option value="VIII" @if (old('kelas_pendidikan_formal', $data->kelas_pendidikan_formal) == 'VIII') {{ 'selected' }} @endif>VIII</option>
                                                <option value="IX" @if (old('kelas_pendidikan_formal', $data->kelas_pendidikan_formal) == 'IX') {{ 'selected' }} @endif>IX</option>
                                                <option value="X" @if (old('kelas_pendidikan_formal', $data->kelas_pendidikan_formal) == 'X') {{ 'selected' }} @endif>X</option>
                                                <option value="XI" @if (old('kelas_pendidikan_formal', $data->kelas_pendidikan_formal) == 'XI') {{ 'selected' }} @endif>XI</option>
                                                <option value="XII" @if (old('kelas_pendidikan_formal', $data->kelas_pendidikan_formal) == 'XII') {{ 'selected' }} @endif>XII</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        <label class="col-sm-2 col-form-label col-form-label-sm text-dark">Pendidikan
                                            Diniyyah</label>
                                        <div class="col-sm-4">
                                            <select class="form-select form-select-sm" name="diniyyah"
                                                aria-label=".form-select-sm example">
                                                <option selected disabled>Pilih Jenis Diniyyah</option>
                                                <option value="ULA" @if (old('diniyyah', $data->diniyyah) == 'ULA') {{ 'selected' }} @endif>ULA</option>
                                                <option value="WUSTHO" @if (old('diniyyah', $data->diniyyah) == 'WUSTHO') {{ 'selected' }} @endif>WUSTHO</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-select form-select-sm" name="kelas_diniyyah"
                                                aria-label=".form-select-sm example">
                                                <option selected disabled>Pilih Kelas</option>
                                                <option value="I" @if (old('kelas_diniyyah', $data->kelas_diniyyah) == 'I') {{ 'selected' }} @endif>I</option>
                                                <option value="II" @if (old('kelas_diniyyah', $data->kelas_diniyyah) == 'II') {{ 'selected' }} @endif>II</option>
                                                <option value="III" @if (old('kelas_diniyyah', $data->kelas_diniyyah) == 'III') {{ 'selected' }} @endif>III</option>
                                            </select>
                                        </div>
                                    </div>
                                    <hr class="mt-3 mb-3" />
                                    <div class="form-group row mt-4">
                                        <label class="col-sm-2 col-form-label col-form-label-sm text-dark">Nama Kepala
                                            Keluarga</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control form-control-sm"
                                    ...
                                    <div class="form-group row mt-4">
                                        <label class="col-sm-2 col-form-label col-form-label-sm text-dark">Status Kepala
                                            Keluarga</label>
                                        <div class="col-sm-4">
                                            <select class="form-select form-select-sm" name="status_kepala_keluarga"
                                                aria-label=".form-select-sm example">
                                                <option selected disabled>Pilih Status</option>
                                                <option value="Ayah" @if (old('status_kepala_keluarga', $data->status_kepala_keluarga) == 'Ayah') {{ 'selected' }} @endif>Ayah</option>
                                                <option value="Ibu" @if (old('status_kepala_keluarga', $data->status_kepala_keluarga) == 'Ibu') {{ 'selected' }} @endif>Ibu</option>
                                                <option value="Kakak" @if (old('status_kepala_keluarga', $data->status_kepala_keluarga) == 'Kakak') {{ 'selected' }} @endif>Kakak</option>
                                                <option value="Paman" @if (old('status_kepala_keluarga', $data->status_kepala_keluarga) == 'Paman') {{ 'selected' }} @endif>Paman</option>
                                                <option value="Kakek" @if (old('status_kepala_keluarga', $data->status_kepala_keluarga) == 'Kakek') {{ 'selected' }} @endif>Kakek</option>
                                                <option value="Nenek" @if (old('status_kepala_keluarga', $data->status_kepala_keluarga) == 'Nenek') {{ 'selected' }} @endif>Nenek</option>
                                            </select>
                                        </div>
                                    </div>
                            </div>
