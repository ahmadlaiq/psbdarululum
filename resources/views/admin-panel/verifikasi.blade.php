...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-dark">Verifikasi Pendaftaran</h1>
            {{-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                class="fas fa-download fa-sm text-white-50"></i> Unduh Bukti Pembayaran</a> --}}
        </div>
        <div class="card">
            <div class="card-header text-dark">
                <strong>Silahkan Verifikasi Pendaftaran</strong>
            </div>
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($formmulir as $f)
                            <tr class="">
                                ...
                                <td>
                                    <div class="row">
                                        <form action="{{ route('admin.update-terima', $f->berkas->id) }}" method="POST">
                                            @csrf
                                            @method('put')
                                            <input type="hidden" name="status_pendaftaran" value="lulus">
                                            <button class="btn btn-success btn-sm mr-2" type="submit">
                                                Terima
                                            </button>
                                        </form>
                                        <form action="{{ route('admin.update-tolak', $f->berkas->id) }}" method="POST">
                                            @csrf
                                            @method('put')
                                            <input type="hidden" name="status_pendaftaran" value="tidak lulus">
                                        ...
                                        <div class="modal-body">
                                            @if ($f->berkas->bukti_pembayaran)
                                                <img src="{{ asset('storage/' . $f->berkas->bukti_pembayaran) }}"
                                                    class="card-img-top" alt="KTP Orang Tua/Wali">
                                            @else
